...
def get_parser() -> ArgumentParser:
    ...
    parser.add_argument("--input_depth", type=Path, required=True, help="Path to depthimage(s) to infer.")
...
def infer(args: Namespace):
    ...
    dataset = InferenceDataset(
        args.input, args.input_depth, image_size=tuple(config.dataset.image_size), transform=transform  # type: ignore
    )
    ...
    # print(model.pixel_threshold.value)
